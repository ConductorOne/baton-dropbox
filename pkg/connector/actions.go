...
func (c *Connector) disableUserActionHandler(ctx context.Context, args *structpb.Struct) (*structpb.Struct, annotations.Annotations, error) {
	...
	if err := c.disableUser(ctx, teamMemberID); err != nil {
...
func (c *Connector) enableUserActionHandler(ctx context.Context, args *structpb.Struct) (*structpb.Struct, annotations.Annotations, error) {
	...
	if err := c.enableUser(ctx, teamMemberID); err != nil {
...
// disableUser disables a user by their team member ID (suspends the account).
func (c *Connector) disableUser(ctx context.Context, teamMemberID string) error {
	_, err := c.client.SuspendMember(ctx, teamMemberID)
	if err != nil {
		return fmt.Errorf("failed to disable member %s: %w", teamMemberID, err)
	}
	return nil
}

// enableUser enables a user by their team member ID (unsuspends the account).
func (c *Connector) enableUser(ctx context.Context, teamMemberID string) error {
	_, err := c.client.UnsuspendMember(ctx, teamMemberID)
	if err != nil {
		return fmt.Errorf("failed to enable member %s: %w", teamMemberID, err)
	}
	return nil
}
