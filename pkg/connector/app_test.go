...
func TestAppBuilder_StaticEntitlements_ReturnsAccessEntitlement(t *testing.T) {
	b := newAppBuilder()

	entitlements, _, err := b.StaticEntitlements(context.Background(), resourceSdk.SyncOpAttrs{})
	require.NoError(t, err)
